...
userRoutes.get("/", verifyToken.execute, userControllers.getAllUsers)

userRoutes.put("/", verifyToken.execute, IsValidBody.execute({ body: createUserSchema }), userControllers.updateUser)
